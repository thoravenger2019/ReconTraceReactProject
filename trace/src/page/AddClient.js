...
const AddClient = props => {
    ...
    const [finalchannelwisedata,setFinalChannelWiseData]=useState([])
    const [count,setCountData]=useState(1)
    const [firstData,setTableData]=useState([]);
    ...
    // console.log(finalchannelwisedata);
    // console.log(count);
...
// setTableData(lenData);
    const handleAdd = () => {
        ...
        //const finaldataSource=[dataSource,...newData];
        //setFinalChannelWiseData(finaldataSource);
