    ...
    try {
      ...
      if (switchCheck == 'SWITCH' && glCheck == 'GL') {
       ...
       // const response = await axios.post(`http://192.168.1.34:8080/Admin/api/joinopt/${clientid}/${channelid}/${modeid}/${ruletype}/${switchCheck + ',' + glCheck}/${switchTempName}/${glTempName}/${selectionType}`,lenData);
        ...
        var jsondata={
          ...
          "jsonString":JSON.stringify(matchtbl)
        }
        var response;
        $.ajax({
          type: "POST",
      ...
      if (npciacqcheck == 'NPCIACQ') {
        ...
        var jsondata={
          ...
          "joinCond":JSON.stringify(selectionType),
          "jsonString":JSON.stringify(matchtblnpciacqdata)
        }
      ...
      if (ejCheck == 'EJ') {
        ...
        var jsondata={
          ...
          "joinCond":JSON.stringify(selectionType),
          "jsonString":JSON.stringify(matchtbleej)
        }
  ...
  return (
    ...
    />
                ...
                <Row gutter={[16, 16]}>
                  <Col span={4}>
                    {matchtblNew ? (
                      <Table dataSource={matchtblNext} columns={columnsmatchNext} rowSelection={{
                        type: selectionType,
                        ...rowSelection,
                      }}
                        pagination={false}
                    ...
                    {matchtablenpciacq ? (
                      <Table dataSource={matchtbldataNPCIACQnext} columns={columnsmatchNpciacq} rowSelection={{
                        type: selectionType,
                        ...rowSelection,
                      }}
                        pagination={false}
                    ...
                    <Col span={6} >
                      ...
                      /> */}
                          <Table
                              components={{
                                body: {
                                  cell: EditableCellNPCIISS,
                                  row: EditableRowNPCIISS,
                                },
                              }}
                              style={{ width: 800 }}
                              dataSource={matchtblnpcidata} 
                              columns={mergedColumnsNPCIISS}
                              pagination={false}
                              rowClassName="editable-row"
                              scroll={{ y: 400 }}
                              bordered
                    ...
                    <Col span={6} >
                      ...
                      /> */}
                            ...
                            <Table
                              components={{
                                body: {
                                  cell: EditableCellNPCI,
                                  row: EditableRowNPCI,
                                },
                              }}
                              style={{ width: 800 }}
                              dataSource={matchtblnpciacqdata} 
                              columns={mergedColumnsnpciACQ}
                              pagination={false}
                              rowClassName="editable-row"
                              scroll={{ y: 400 }}
                              bordered
                  ...
                  matchtblej ? (
                    <Col span={6} >
                      {/* <Table dataSource={matchtbleej} columns={mergedColumnsEJ}
                        bordered
                        pagination={false}
                      /> */}
                          <Table
                              ...
                              style={{ width: 800 }}
                              dataSource={matchtbleej} 
                              columns={mergedColumnsEJ}
                              pagination={false}
                              rowClassName="editable-row"
                              scroll={{ y: 400 }}
                              bordered
