...
//					HSSFWorkbook wb = new HSSFWorkbook(pos.getInputStream());
	...
	public List<JSONObject> importGlcbsFileData(MultipartFile glCbs, String clientid, String createdby) {
		...
		try {
			...
			String str = "VALUE_DATE", str2 = "TRAN_TIME", str3 = "TERMINAL_ID", str4 = "ACCOUNT_NUM",
					str5 = "CUST_OR_CARD_ID", str6 = "RNN_NO", str7 = "AMOUNT", str8 = "WITHDRAWALFLAG",
					str9 = "RESPONSECODE", str10 = "REVERSALFLAG", str11 = "DRCR", str12 = "TRANSTYPE",
					str13 = "MERCHANT_TYPE";
			int tempcolindex = -1;
			String tempstr = null;
			...
			for (Row row : sheet) {
				for (Map.Entry entry : hm.entrySet()) {
					...
					if (entry.getValue().equals(str10)) {
						String key = entry.getKey().toString();
					...
					if (entry.getValue().equals(str11)) {
						String key = entry.getKey().toString();
					...
					if (entry.getValue().equals(str12)) {
						String key = entry.getKey().toString();
					...
					if (entry.getValue().equals(str13)) {
						String key = entry.getKey().toString();
...
//			System.out.println("xls");
//			try {
//				String SlNo = null, Transdate = null, Time = null,
//						Terminal_ID = null, AccountNo = null, CardNumber = null,
//								TraceNo = null, Amount = null, WithdrawalFlag = null,
//										Response = null, ReversalFlag = null, Db_Cr = null,
//												TransType = null, MerchantType = null;
//				List xlstermList = new ArrayList();
////				POIFSFileSystem fs = new POIFSFileSystem(reapExcelDataFile.getInputStream());
////				File convFile = new File(glCbs.getOriginalFilename());
////				convFile.createNewFile();
...
//						else
//						{
//							Transdate = row.getCell(1).toString();
//						}
//						if(tempRow.getCell(2)==null)
//						{
//							Time=null;
...
//						else
//						{
//							Terminal_ID = row.getCell(3).toString();
//						}
//						if(tempRow.getCell(4)==null)
//						{
//							AccountNo=null;
...
//						else
//						{
//							AccountNo = row.getCell(4).toString();
//						}
//						if(tempRow.getCell(5)==null)
//						{
//							CardNumber=null;
...
//						}
//						
//						TraceNo = row.getCell(6).toString();
//						Amount = row.getCell(7).toString();
//						WithdrawalFlag = row.getCell(8).toString();
//						Response = row.getCell(9).toString();
//						ReversalFlag = row.getCell(10).toString();
//						Db_Cr = row.getCell(11).toString();
//						TransType = row.getCell(12).toString();
//						MerchantType = row.getCell(13).toString();
////						
////						System.out.println("AccountNo"+SlNo);
////
//////						StoredProcedureQuery query = entityManager
//////								.createStoredProcedureQuery("SPIMPORTPRESENTMENTREPORT");
//////						query.registerStoredProcedureParameter(1, String.class, ParameterMode.IN);
